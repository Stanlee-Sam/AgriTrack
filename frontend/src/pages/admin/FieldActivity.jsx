  ...
  return (
    ...
    >
      ...
      <section className="mt-6 grid gap-6 lg:grid-cols-3">
        ...
        <div className="rounded-2xl border border-outline-variant bg-surface-container-lowest p-6">
          <h2 className="text-[1.5rem] font-semibold leading-[1.4] text-on-surface">Fields</h2>
          <p className="mt-3 text-base font-normal leading-[1.6] text-on-surface-variant">
        ...
        <div className="rounded-2xl border border-outline-variant bg-surface-container-lowest p-6">
          <h2 className="text-[1.5rem] font-semibold leading-[1.4] text-on-surface">Activity</h2>
          <p className="mt-3 text-base font-normal leading-[1.6] text-on-surface-variant">
